...
set DEFAULT_JVM_OPTS="--module-path" "%APP_HOME%\lib" "--module" "biblioteca.biblioteca/biblioteca.biblioteca.BibliotecaApplication"
...
"%JAVA_EXE%" %JAVA_OPTS% %BIBLIOTECA_OPTS% %DEFAULT_JVM_OPTS% %*
